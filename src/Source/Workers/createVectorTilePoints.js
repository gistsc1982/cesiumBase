...
define(['./AttributeCompression-2b8069f2', './Cartesian2-b83e6941', './Math-0cb8fde5', './createTaskProcessorWorker', './Check-285f6bfc', './when-f31b6bd1'], function (AttributeCompression, Cartesian2, _Math, createTaskProcessorWorker, Check, when) { 'use strict';
