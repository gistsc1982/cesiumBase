...
typeof window < "u" && (document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
	v.init();
}) : v.init(), window.__cesiumEventManager__ = v);
//#endregion
...
function S(t, n, r, s, c, l) {
	return u(), a(e, null, [i(" 基础组件无界面元素，仅作为逻辑基类 "), o("div", x)], 2112);
}
//#endregion
//#region src/components/functionPanelUIBase.vue
var C = {
	name: "FunctionPanelUIBase",
	mixins: [/* @__PURE__ */ y(b, [["render", S]])],
	inject: {
	...
	return u(), r(t, { to: "body" }, [
		s(n, { name: "panel-fade" }, {
			default: h(() => [b.isClosed ? i("v-if", !0) : (u(), a("div", {
				...
				}, [o("div", w, [f[5] ||= o("div", { class: "drag-indicator" }, [
					o("span", { class: "grip-dot" }),
					o("span", { class: "grip-dot" }),
					o("span", { class: "grip-dot" })
				], -1), d(e.$slots, "header", {}, () => [o("h3", T, p(v.title), 1)], !0)]), o("div", E, [v.allowMinimize ? (u(), a("button", {
					key: 0,
					onClick: f[0] ||= _((...e) => x.toggleMinimize && x.toggleMinimize(...e), ["stop"]),
					class: "icon-btn minimize-btn",
					type: "button",
					"aria-label": b.isMinimized ? "展开" : "最小化"
				}, [(u(), a("svg", O, [b.isMinimized ? (u(), a("path", A)) : (u(), a("path", k))]))], 8, D)) : i("v-if", !0), o("button", {
				...
				s(n, {
					...
					}, [d(e.$slots, "default", {}, void 0, !0)], 4), [[m, !b.isMinimized]])]),
					_: 3
				})
			], 38))]),
			_: 3
		...
		s(n, { name: "fab-fade" }, {
			default: h(() => [!b.isClosed && b.isMinimized ? (u(), a("button", {
				...
				title: v.title
			}, [o("span", N, p(v.titleIcon || "⚙️"), 1), o("span", P, p(v.title), 1)], 12, M)) : i("v-if", !0)]),
			_: 1
		})
	]);
}
...
var I = {
	name: "TestPanel",
	components: { FunctionPanelUIBase: /* @__PURE__ */ y(C, [["render", F], ["__scopeId", "data-v-5551e28d"]]) },
	props: {
		initialX: {
			type: [Number, String],
			default: "right"
...
}, L = { class: "test-panel-content" }, R = { class: "demo-section" }, z = { class: "status-info" }, B = { class: "status-item" }, V = { class: "value" };
function H(e, t, n, i, a, s) {
	...
	return u(), r(c, {
		...
		default: h(() => [o("div", L, [
			...
			o("div", z, [
				o("div", B, [t[3] ||= o("span", { class: "label" }, "组件名称:", -1), o("span", V, p(a.componentName), 1)]),
...
var U = /*#__PURE__*/ y(I, [["render", H], ["__scopeId", "data-v-db53db50"]]);
//#endregion
export { U as default };
